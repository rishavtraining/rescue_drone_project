...
* Filename: 2_key_control.py

* Functions: velocity_control(),Establish_Connection_to_Drone(),arm_and_takeoff(),Perfom_Actions(),on_press(),on_release(vehicle,key)

* Global Variables: Vx,Vy,Vz,t_flag
