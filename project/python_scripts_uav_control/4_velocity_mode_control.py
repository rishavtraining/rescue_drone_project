...
* Filename: 4_velocity_mode_control.py

* Functions: velocity_control(),Establish_Connection_to_Drone(),arm_and_takeoff()
...
def Establish_Connection_to_Drone() :
    ...
    ConnectionString = ConnectionString = "/dev/ttyS0"
